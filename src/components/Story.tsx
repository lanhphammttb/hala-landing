          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              ...
              <div className="space-y-6 text-gray-600 text-lg font-light leading-relaxed mb-12">
                <p>
                  So với việc sản xuất hàng loạt công nghiệp, chúng mình lựa chọn đi chậm lại. Tại Hala Handmade, một chiếc túi có thể tốn vài ngày để hoàn thiện, nhưng đó là sự đầu tư xứng đáng cho chất lượng.
                </p>
              </div>
